...
int8_t bmm150_user_i2c_reg_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t length, void *intf_ptr)
{
	...
	uint8_t res = HAL_I2C_Mem_Write(&hi2c1, (0x10)<<1, reg_addr, I2C_MEMADD_SIZE_8BIT, (uint8_t *)reg_data, length, 100);
	return res;
}
...
int8_t bmm150_user_i2c_reg_read(uint8_t reg_addr, uint8_t *reg_data, uint32_t length, void *intf_ptr)
{
	...
	uint8_t res = HAL_I2C_Mem_Read(&hi2c1, (0x10)<<1, reg_addr, I2C_MEMADD_SIZE_8BIT, (uint8_t *)reg_data, length, 100);//(&hi2c1, reg_addr, (uint8_t *)reg_data, (uint16_t)len, 25);
	return res;
}
